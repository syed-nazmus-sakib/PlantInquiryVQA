...
def call_mistral_model(model_name: str, image_url: str, questions_so_far: List[str]) -> str:
    try:
        conversation_text = ""
...
def run_test2_for_image(image_id: str, qa_pairs: List[Dict], image_path: str) -> Dict:
    ...
    for i, qa in enumerate(qa_pairs, 1):
        ...
        model_answer = call_mistral_model(model_name, image_url, questions_so_far)
