...
results = []
checkpoint_file = f"{OUTPUT_DIR}/qwen3vl_2b_test2_checkpoint.jsonl"
...
results_csv = f"{OUTPUT_DIR}/qwen3vl_2b_test2_results.csv"
...
with open(f"{OUTPUT_DIR}/qwen3vl_2b_test2_summary.json", 'w') as f:
