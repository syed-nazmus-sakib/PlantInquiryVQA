...
print("\n[4/6] Loading LLaVA-1.5-13B model...")
...
print("✓ LLaVA-1.5-13B loaded successfully")
...
results = []
checkpoint_file = f"{OUTPUT_DIR}/llava15_13b_test2_checkpoint.jsonl"
...
results_csv = f"{OUTPUT_DIR}/llava15_13b_test2_results.csv"
...
with open(f"{OUTPUT_DIR}/llava15_13b_test2_summary.json", 'w') as f:
