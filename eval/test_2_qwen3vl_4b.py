...
print("="*80)
print("TEST 2: QUESTION-ONLY PROTOCOL GUIDANCE - QWEN3-VL-4B")
print("="*80)
...
print("✓ Qwen3-VL-4B loaded successfully")

print("\n[5/6] Running TEST 2: Question-Only Scaffolding...")

evaluator = VQAEvaluator()
results = []
checkpoint_file = f"{OUTPUT_DIR}/qwen3vl_4b_test2_checkpoint.jsonl"
...
results_csv = f"{OUTPUT_DIR}/qwen3vl_4b_test2_results.csv"
...
with open(f"{OUTPUT_DIR}/qwen3vl_4b_test2_summary.json", 'w') as f:
...
print("\n✓ TEST 2 COMPLETE: QUESTION-ONLY SCAFFOLDING - QWEN3-VL-4B")
print("="*80)
