...
OUTPUT_BASE_DIR = "test1a_additional_models_results"

SAVE_INTERVAL = 25

MODEL_NAME = 'meta-llama/llama-3.2-90b-vision-instruct'
OUTPUT_DIR = 'llama_3_2_90b_vision'
...
def call_model(image_url: str, conversation_history: List[Dict], 
...
def run_test1a_for_image(image_id: str, qa_pairs: List[Dict], 
    ...
    for i, qa in enumerate(qa_pairs, 1):
        ...
        model_answer = call_model(image_url, conversation_history, qa['question'])
