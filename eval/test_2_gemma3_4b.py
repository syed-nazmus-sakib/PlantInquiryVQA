...
print("✓ Gemma3-4B loaded successfully")

print("\n[5/6] Running TEST 2: Question-Only Scaffolding...")

evaluator = VQAEvaluator()
results = []
checkpoint_file = f"{OUTPUT_DIR}/gemma3_4b_test2_checkpoint.jsonl"
...
results_csv = f"{OUTPUT_DIR}/gemma3_4b_test2_results.csv"
...
with open(f"{OUTPUT_DIR}/gemma3_4b_test2_summary.json", 'w') as f:
