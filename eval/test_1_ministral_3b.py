...
OUTPUT_BASE_DIR = "test1a_ministral_results"

SAVE_INTERVAL = 25

MODEL_NAME = 'mistralai/ministral-3b-2512'
OUTPUT_DIR = 'ministral_3b'
...
def call_ministral_model(image_url: str, conversation_history: List[Dict], 
...
def run_test1a_for_image(image_id: str, qa_pairs: List[Dict], 
    ...
    for i, qa in enumerate(qa_pairs, 1):
        ...
        model_answer = call_ministral_model(image_url, conversation_history, qa['question'])
