...
OUTPUT_BASE_DIR = "test1a_nemotron_results"

SAVE_INTERVAL = 25

MODEL_NAME = 'nvidia/nemotron-nano-12b-v2-vl:free'
OUTPUT_DIR = 'nemotron_nano_12b'
...
def call_nemotron_model(image_url: str, conversation_history: List[Dict], 
...
def run_test1a_for_image(image_id: str, qa_pairs: List[Dict], 
    ...
    for i, qa in enumerate(qa_pairs, 1):
        ...
        model_answer = call_nemotron_model(image_url, conversation_history, qa['question'])
