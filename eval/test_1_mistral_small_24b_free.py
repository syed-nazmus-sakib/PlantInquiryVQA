...
OUTPUT_BASE_DIR = "test1a_free_models_results"

SAVE_INTERVAL = 25

MODEL_NAME = 'mistralai/mistral-small-3.1-24b-instruct:free'
OUTPUT_DIR = 'mistral_small_24b_free'
...
def call_mistral_model(image_url: str, conversation_history: List[Dict], 
...
def run_test1a_for_image(image_id: str, qa_pairs: List[Dict], 
                        image_path: str) -> Dict:
    ...
    for i, qa in enumerate(qa_pairs, 1):
        ...
        model_answer = call_mistral_model(image_url, conversation_history, qa['question'])
...
def main():
    print("="*80)
    print(f"TEST 1A: {MODEL_NAME}")
    print("="*80)
    print("NOTE: This is a FREE model - no API costs!")
    ...
    for idx, (image_id, qa_pairs) in enumerate(pbar, start=start_index):
        ...
        try:
            result = run_test1a_for_image(image_id, qa_pairs, image_path)
    ...
    output_data = {
        'metadata': {
            'test_name': f'Test 1A - {OUTPUT_DIR}',
            'model': MODEL_NAME,
            'cost': 'FREE',
